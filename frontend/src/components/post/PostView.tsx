		...
		<Container>
			...
			<div className="flex justify-center">
				<div className="flex space-x-2">
					<button
						type="button"
						className="relative flex w-[120px] md:w-[136px] py-2 text-xs md:text-sm items-center justify-center rounded-md border border-gray-500/30 bg-white text-gray-700 hover:border-gray-500/70 focus:z-10 focus:outline-none focus:ring-0 dark:border-gray-500/70 dark:bg-gray-700 dark:text-gray-300 dark:hover:border-gray-500/30"
					>
			...
			{/* TAGS */}
			<TagList tagList={['태그1', '태그2', '태그3']} size="xs" />

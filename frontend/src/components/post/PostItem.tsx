		...
		<div>
			<li className="py-4 border-b first:border-t border-gray-500/30 dark:border-gray-500/70">
				<div className="flex flex-col">
					...
					<div className="flex">
						<div className="flex items-center gap-x-1 sm:gap-x-2 w-full">
							{['태그1', '태그2', '태그3', '태그3', '태그3', '태그3', '태그3', '태그3'].map(
								(tagName, i) => (
									<Link
										key={i}
										className="line-clamp-1 text-xs font-normal leading-5 text-gray-600 dark:text-gray-400 sm:text-sm"
										href="/"
									>
										#{tagName}
									</Link>
						...
						<div className="flex justify-end items-center gap-x-2 text-gray-700 dark:text-gray-300">
